...
func _ready():
	...
	aws_games_sdk_auth.fb_link.connect(on_link_facebook_id_response)
	aws_games_sdk_auth.fb_login.connect(on_login_with_facebook_id_response)
...
func _on_login_success():
	...
	aws_games_sdk_auth.link_facebook_id_to_current_user("AcceessTokenHere", "UserIdHere")
...
func on_link_facebook_id_response():
	...
	aws_games_sdk_auth.login_with_facebook_access_token("AccessTokenHere", "UserIdHere")
	
	
func on_login_with_facebook_id_response():
